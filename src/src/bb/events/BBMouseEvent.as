...
//		static public const ROLL_OVER:String = "rollOver";
		...
		/**
		 */
		public function BBMouseEvent(p_type:String = "", p_target:BBNode = null, p_dispatcher:BBNode = null,
		                             p_localX:int = 0, p_localY:int = 0, p_buttonDown:Boolean = false, p_ctrlDown:Boolean = false)
		{
			type = p_type;
			target = p_target;
		 ...
		 */
		static public function get(p_type:String = "", p_target:BBNode = null, p_dispatcher:BBNode = null,
				                   p_localX:int = 0, p_localY:int = 0, p_buttonDown:Boolean = false, p_ctrlDown:Boolean = false):BBMouseEvent
		{
