 ...
 * Time: 12:12
 */
package src.bb.components.physics.joints
{
	 ...
	 * For internal use.
	 */
	public class BBConstraintFactory
	{
		...
		{
			var pivotJoint:PivotJoint = new PivotJoint(p_joint.thisBody, p_joint.jointedBody, p_joint.thisAnchor, p_joint.jointedAnchor);
