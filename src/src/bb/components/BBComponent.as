package src.bb.components
{
	...
	{
		/**
		 * Is should component cached by default.
		 */
		static public var CACHING_COMPONENT:Boolean = true;
		...
		/**
		 * If this component will be cached.
		 */
		...
		{
			var component:BBComponent = BBComponentPool.get(componentClass);
